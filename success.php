...
$sosrequest =$_POST['sosrequest'];
$soslocation =$_POST['soslocation'];
$sospicture =$_FILES['sospicture'];

$sql = "INSERT INTO sos SET username='$sosname', phoneno='$sosphone', request='$sosrequest', soslocation='$soslocation', imgproof='$sospicture' ";
