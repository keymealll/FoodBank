  ...
  ?>
    ...
    <div class="container">
        ...
        <div class="col-sm-4  ">
            <div class="container">
                <br>
                <img src="foodbank .png" id="logo" width="80px" height="100px"><br>
                <div class="card" style="width: auto; height: 550px; overflow-y: auto;">
                    ...
                    <?php while ($row= mysqli_fetch_assoc($result)){ ?>
                        <div class="card" id="carddetail" style="width: auto; height:auto;">
                            <div class="card-body">
                              ...
                              <h6 class="card-subtitle mb-2 text-muted" name="location"><?php echo $row["foodlocation"]?></h6>
                              <p class="card-text"><?php echo $row["phoneno"]?></p>
                              <a href="#" class="card-link"><?php echo $row["website"]?></a>
                            </div>
                          </div>
                          <br>
                    <?php } ?>        
                  ...
                  <br>
                  <p id="ask">Do you have a food bank?</p>
                  <div class="d-flex justify-content-center">
                   <a href="inputsos.php    "> <button type="button" name="send" id="send" class="btn btn-default">Create New</button></a>
                    </div>
                </div> 
        </div>
        <div class="col-sm-7">
